	...
	<form  name="form1" action="<?php echo U(do_add);?>" method="post"  enctype="multipart/form-data">
        <table width="98%" border="0" cellspacing="1" cellpadding="1">
          <tr> 
            ...
            <td width="90%" style="text-align:left;"><input name="title" type="text" id="title" size="16" style="width:300px" /> &nbsp;
           </td>
          </tr>
          ...
          <tr> 
            ...
            <td style="text-align:left;">
            	<select name="typeid" style="width:300px" >
                 ...
                 <?php if(is_array($category)): foreach($category as $key=>$c): ?><option value="<?php echo ($c['id']); ?>"><?php echo ($c['fullname']); ?></option><?php endforeach; endif; ?>
                </select>
                &nbsp;
            </td>
          </tr>
          ...
          <tr> 
            ...
            <td width="90%" style="text-align:left;"><textarea name="url" style="width:300px;height:60px" ></textarea> &nbsp;
           </td>
          </tr>
           <tr> 
            <td height="30">排序：</td>
